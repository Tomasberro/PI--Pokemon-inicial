import { GET_POKEMONS, POKEMONS_CREATED, ORDER_BY_NAME, ORDER_BY_POWER, GET_POKEMONS_NAME, GET_POKEMONS_ID, POST_POKEMONS, GET_TYPES, POKEMONS_TYPES_FILTER, CLEAN_ACTION, ADD_FAVORITES, REMOVE_FAVORITES } from "../actions/actionsTypes";
